...
# Settings for ArangoDB
graphName=arangodb
groupId=com.arangodb
artifactId=blueprints-arangodb-graph
version=1.0.15   #$1
tmpConfig=conf/${graphName}_x.properties 
graphPath=com.arangodb.blueprints.ArangoDBGraph
...
gremlin.arangodb.directory=$location
EOF`
